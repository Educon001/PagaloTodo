...
namespace UCABPagaloTodoMS.Infrastructure.Migrations
{
    ...
    [Migration("20230701225357_PaymentsConfigMigration")]
    partial class PaymentsConfigMigration
    {
            ...
            modelBuilder.Entity("UCABPagaloTodoMS.Core.Entities.AdminEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fb91d3d4-a257-4eae-b654-c16b37b0524a"),
                            CreatedAt = new DateTime(2023, 7, 1, 22, 53, 57, 435, DateTimeKind.Utc).AddTicks(4606),
                            CreatedBy = "APP",
                            Email = "pagalotodoucabaf@gmail.com",
                            IsDeleted = false,
                            Name = "admin",
                            PasswordHash = "$PagalTodo$10000$BBfBi2iwnD9YBHx2gmIrxv00H6U+evcHZtjVpzVkZSIaARHk",
                            Status = true,
                            Username = "admin"
                        });
                });
